...
function createLayerPatterns(state, wireframeRenderer, backgroundGradient, pulseRings) {
...
function bootUnifiedDemo() {
    ...
    const patterns = createLayerPatterns(inputs.state, wireframeRenderer, backgroundGradient, pulseRings);
