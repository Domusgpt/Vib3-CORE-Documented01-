...
function createLayerPatterns(state, wireframeRenderer, backgroundGradient, pulseRings, highlightStreaks) {
...
function bootUnifiedDemo() {
    ...
    const patterns = createLayerPatterns(inputs.state, wireframeRenderer, backgroundGradient, pulseRings, highlightStreaks);
